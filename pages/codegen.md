ON A ROLL MF!! Let us save the current game and not push my luck... Alright, all committed. Here the latest version for the record:
...
export default function Component() {
  ...
  const fadePercentage = Math.max(100 - (scrollPosition / headerHeight) * 100, 0)
      ...
      <div className={`relative z-20 transition-colors duration-300 ease-in-out ${fadePercentage === 0 ? 'bg-white' : ''}`}>
        ...
        <div className="container mx-auto"> 
          ...
          >
            ...
            >
              <h1 className="text-title-white">READY TO CRASH SOME HABITS?</h1>
            </motion.div>
          </div>
        </div>

        {/* Sticky Top */}
        <div className="sticky top-3 z-30 bg-white m-4">
          <div className="container mx-auto px-">
            <div className="flex items-center border-y p-1">
            ...
            {/* Widgets wraper */}
            <div className="bg-white pt-6 p-3 space-y-1 rounded-t-xl">
